...
public class UDFSM4DecryptTest extends UDFBaseTest {

	@Override
	public GenericUDF createUDF() {
		return new UDFSM4Decrypt();
	}
	...
	public void testUdf_normalTextValue_ok() throws HiveException {
		Text actual = evaluate("8392835f5fe1432f253792adf22fc6b8", "hNLJj#@FgPQYygQA");
		assertEquals(new Text("19999999999"), actual);
	}
	...
	public void testUdf_normalBinaryValue_ok() throws HiveException {
		...
		final byte[] expected = "19999999999".getBytes();
		ImmutableBytesWritable actual = evaluate(
				new ImmutableBytesWritable("8392835f5fe1432f253792adf22fc6b8".getBytes(), true),
